        ...
        <div class="invoice-items table-responsive">
            ...
            <table class="table" style="background:white;">
                ...
                <tbody style="background:white;">
                    ...
                    <tr>
                        <td colspan="3"><b>Sum: <label for="" id="invoice-total"></label></b></td>
                        <td class="calculations" style="text-align: right;"><b>Total</b></td>
                        <td class="text-center" id="invoice_total_in_number">{{ $subtotal /100 * $data[0]["get_one_record_client"]["tax"] + $subtotal}}</td>
                    </tr>
