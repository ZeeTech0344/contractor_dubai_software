...
@section('content')
    ...
    @foreach ($contractor_info as $partnership)
        <button  class="btn btn-sm btn-warning contractor_grand_detail" style="margin-right: 10px;" data-id="{{$partnership->getContractor->id.",".$partnership->getContractor->name}}"> <i class="fas fa-solid fa-caret-up"></i> {{ $partnership->getContractor->name }} Contract List</button>
    @endforeach
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" id="remaing_amount_get">
                                {{ $total - $total_expense - $total_pay }}<label> AED</label></td>
                        </tr>
                    </tbody>
                </table>
            </div>
