    ...
    <div class="invoice-container text-danger " id="capture_area" style="margin-top:0px;">
            ...
            <table class="table quotation_table" style="background:white;" >
                ...
                <tbody style="background:white; font-size:12px;">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><b>{{$get_data["grand_total"]}}</b></td> <!-- Empty column for total -->
                    </tr>
                    @endif
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="text-center" colspan="2"><label id="invoice_total_in_number"><b>{{ number_format($total_grand)}}</label> AED</b></td>
                    </tr>
                </tbody>
        ...
        <div class="container term_and_condition" style="text-align: justify; color:#b80f00; font-size:12px;">
            ...
            <ul style="margin:0;">
                ...
                <li style="margin:0;">Reliable Home Technical Services requires 50% advance payment of the total amount of the quotation/Invoice.</li>
...
function convertAmountToWords(amount) {
    ...
    let words = "Sum: "+numberToWords(parseInt(dollars)) + ' Dirham';
    ...
    return words;
        ...
        console.log(stringWithoutCommas/3);
        amount_in_words = $("#invoice-total").html(convertAmountToWords(stringWithoutCommas));
    </script>
@endsection
