        ...
        <form class="form-horizontal" id="buyer_purchaser_detail">
            ...
            <div class="card-body" style="padding-bottom:0;">
                ...
                <div class="form-group row supplier_field">
                    ...
                    <div class="col-sm-10">
                        <select disabled class="form-control toselect-tag" name="buyer_purchaser_id"
...
<div class="col-md-6">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h2 class="card-title">Quotation View &nbsp;&nbsp;&nbsp;  Sum(<label id="sum"> </label>)</h2>
        ...
        <div class="card-body table-responsive p-0">
            ...
            <div class="p-3 d-flex justify-content-end"><input type="button" class="btn btn-warning" value="Save"
    ...
    $("#buyer_purchaser_detail").submit(function(event) {
        ...
        if ($("#type").val() == "Suppliers" && $("#amount_status").val() == "Bill") {
            ...
            if (editedRow) {
                ...
                const newArray = values.slice(5,9);
                ...
                values.forEach(function(value, index) {
                    ...
                    if (fieldName && fieldName !== 'buyer_purchaser_id' && fieldName !==
                        ...
                        fieldName !== 'amount_status_hidden_value' && fieldName !== 'type' &&
                         fieldName !== 'hidden_id' &&  fieldName !== 'remarks') {
